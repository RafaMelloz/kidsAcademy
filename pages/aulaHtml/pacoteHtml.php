	...
	<section class="stiky">
		<div class="scroll">
			<div class="box">
				...
				<?php
				$modulos = \MySql::conectar()->prepare("SELECT * FROM `modulos_curso` WHERE curso_id =2");
				$modulos->execute();
	...
	<div class="Cprincipal">
		<div class="center">
			<div class="Titulo-Principal">
				<h2>Curso Html e css basico</h2>
				<p>Módulo: Introdução e Conceitos > <span>O começo da jornada!</span></p>
			</div>
			<!--Titulo-Principal-->
			...
			<div class="A-centro">
				<a href="" style="float: left;">
					<< AULA ANTERIOR</a>
						<a href="aula2.php" style="float: right;">PROXIMA AULA >></a>
			</div>
			<!--A-centro-->


			<iframe src="https://www.youtube.com/embed/xQf53cj33PY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		<div class="footer">
			...
			<div class="footer-icon">
				<ul>
					...
					<li><a href="#" target="black"><img src="../../Imagens/facebook.png"></a>
					</li>
