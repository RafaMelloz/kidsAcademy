	...
	<div class="Cprincipal">
		<div class="center">
			<div class="Titulo-Principal">
				...
				<p>Módulo: Introdução e Conceitos > <span> Formatações - Word</span></p>
			</div>
			<!--Titulo-Principal-->

			<div class="A-centro">
				<a href="aula6.php" style="float: left;">
					<< AULA ANTERIOR</a>
						<a href="" style="float: right;">PROXIMA AULA >></a>
			</div>
			<!--A-centro-->


			<iframe width="560" height="315" src="https://www.youtube.com/embed/wkqhdko6_hU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
