...
function getInfoBasedOnScore() {
    if (totalScore() <= 7){
        var score_info = "Melhor esperar um pouco mais :(";
    } else if (totalScore() > 7){
        var score_info = "Parabens! Já pode começar o curso :D";
    }
...
function growProgressBar(percentage_widht) {
    var bar = document.getElementById("progress_bar");
    bar.style.width = percentage_widht;
}
